...
var require_Image = __commonJS({
  "node_modules/.pnpm/react-native-web@0.21.1_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/react-native-web/dist/cjs/exports/Image/index.js"(exports2, module2) {
    ...
    var Image2 = /* @__PURE__ */ React5.forwardRef((props, ref) => {
...
// node_modules/.pnpm/@tamagui+avatar@1.135.2_react-dom@19.1.0_react@19.1.0__react-native@0.81.4_@babel+core@_3c3917e808413d2f87d655b42957a6c3/node_modules/@tamagui/avatar/dist/esm/index.mjs
var esm_exports = {};
...
// node_modules/.pnpm/@tamagui+avatar@1.135.2_react-dom@19.1.0_react@19.1.0__react-native@0.81.4_@babel+core@_3c3917e808413d2f87d655b42957a6c3/node_modules/@tamagui/avatar/dist/esm/Avatar.mjs
...
// node_modules/.pnpm/@tamagui+image@1.135.2_react-dom@19.1.0_react@19.1.0__react-native@0.81.4_@babel+core@7_d233275aa17bd3e6b63103f24b074c5c/node_modules/@tamagui/image/dist/esm/Image.mjs
var import_react4 = __toESM(require("react"), 1);
var import_core = require("@tamagui/core");
var import_react_native_web = __toESM(require_cjs(), 1);
var import_jsx_runtime2 = require("react/jsx-runtime");
var StyledImage = (0, import_core.styled)(import_react_native_web.Image, {
  name: "Image"
});
var hasWarned = false;
var Image = StyledImage.styleable((inProps, ref) => {
  ...
  return finalSource && typeof finalSource == "object" && (process.env.NODE_ENV === "development" && process.env.TAMAGUI_IMAGE_CHECK_ERROR && import_react4.default.useEffect(() => {
    async function run() {
    ...
    __name(run, "run");
    run();
  }, [src]), finalSource.default && (finalSource = finalSource.default)), /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react_native_web.Image, {
...
Image.getSize = import_react_native_web.Image.getSize;
Image.getSizeWithHeaders = import_react_native_web.Image.getSizeWithHeaders;
Image.prefetch = import_react_native_web.Image.prefetch;
Image.prefetchWithMetadata = import_react_native_web.Image.prefetchWithMetadata;
Image.abortPrefetch = import_react_native_web.Image.abortPrefetch;
Image.queryCache = import_react_native_web.Image.queryCache;
...
// node_modules/.pnpm/@tamagui+shapes@1.135.2_react-dom@19.1.0_react@19.1.0__react-native@0.81.4_@babel+core@_309b3dedf0dd86b802245fb3cdca1d14/node_modules/@tamagui/shapes/dist/esm/Square.mjs
var import_web = require("@tamagui/core");

// node_modules/.pnpm/@tamagui+shapes@1.135.2_react-dom@19.1.0_react@19.1.0__react-native@0.81.4_@babel+core@_309b3dedf0dd86b802245fb3cdca1d14/node_modules/@tamagui/shapes/dist/esm/getShapeSize.mjs
var getShapeSize = /* @__PURE__ */ __name((size, {
  tokens
}) => {
...
// node_modules/.pnpm/@tamagui+shapes@1.135.2_react-dom@19.1.0_react@19.1.0__react-native@0.81.4_@babel+core@_309b3dedf0dd86b802245fb3cdca1d14/node_modules/@tamagui/shapes/dist/esm/Square.mjs
var Square = (0, import_web.styled)(ThemeableStack, {
  name: "Square",
  alignItems: "center",
  justifyContent: "center",
  variants: {
...
var AvatarImage = React4.forwardRef((props, forwardedRef) => {
  const {
    __scopeAvatar,
    src,
    ...
    ...imageProps
  } = props, context = useAvatarContext(IMAGE_NAME, __scopeAvatar), [status, setStatus] = React4.useState("idle"), shapeSize = (0, import_core5.getVariableValue)(getShapeSize(
    context.size,
    // @ts-expect-error
    {
      tokens: (0, import_core5.getTokens)()
    }
  )?.width);
  return React4.useEffect(() => {
    setStatus("idle");
  }, [JSON.stringify(src)]), React4.useEffect(() => {
    onLoadingStatusChange(status), context.onImageLoadingStatusChange(status);
  }, [status]), /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(YStack, {
    fullscreen: true,
    zIndex: 1,
    children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Image, {
      fullscreen: true,
...
var AvatarFallback = AvatarFallbackFrame.extractable(React4.forwardRef((props, forwardedRef) => {
  const {
    __scopeAvatar,
    delayMs,
    ...fallbackProps
  } = props, context = useAvatarContext(FALLBACK_NAME, __scopeAvatar), [canRender, setCanRender] = React4.useState(delayMs === void 0);
  return React4.useEffect(() => {
    if (delayMs !== void 0) {
      const timerId = setTimeout(() => setCanRender(true), delayMs);
      return () => clearTimeout(timerId);
    }
  }, [delayMs]), canRender && context.imageLoadingStatus !== "loaded" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AvatarFallbackFrame, {
    ...fallbackProps,
    ref: forwardedRef
  }) : null;
}));
AvatarFallback.displayName = FALLBACK_NAME;
var AvatarFrame = (0, import_core5.styled)(Square, {
  name: AVATAR_NAME,
  position: "relative",
  overflow: "hidden"
});
var Avatar = withStaticProperties(React4.forwardRef((props, forwardedRef) => {
  const {
    __scopeAvatar,
    size = "$true",
    ...avatarProps
  } = props, [imageLoadingStatus, setImageLoadingStatus] = React4.useState("idle");
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AvatarProvider, {
    size,
    scope: __scopeAvatar,
    imageLoadingStatus,
    onImageLoadingStatusChange: setImageLoadingStatus,
    children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AvatarFrame, {
      size,
      ...avatarProps,
      ref: forwardedRef
    })
