...
var require_mergeRefs = __commonJS({
  "node_modules/react-native-web/dist/cjs/modules/mergeRefs/index.js"(exports2, module2) {
    ...
    var React23 = _interopRequireWildcard(require("react"));
    function mergeRefs() {
...
var require_useStable = __commonJS({
  "node_modules/react-native-web/dist/cjs/modules/useStable/index.js"(exports2, module2) {
    ...
    function useStable(getInitialValue) {
      var ref = React23.useRef(UNINITIALIZED);
...
var require_View = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/View/index.js"(exports2, module2) {
    ...
    var View2 = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        React23.Children.toArray(props.children).forEach((item) => {
          if (typeof item === "string") {
            console.error("Unexpected text node: " + item + ". A text node cannot be a child of a <View>.");
          }
        });
      }
      var hasTextAncestor = React23.useContext(_TextAncestorContext.default);
      var hostRef = React23.useRef(null);
...
var require_ScrollViewBase = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/ScrollView/ScrollViewBase.js"(exports2, module2) {
    ...
    var ScrollViewBase = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
      ...
      var scrollState = React23.useRef({
        isScrolling: false,
        scrollLastTick: 0
      });
      var scrollTimeout = React23.useRef(null);
      var scrollRef = React23.useRef(null);
      ...
      return /* @__PURE__ */ React23.createElement(_View.default, (0, _extends2.default)({}, rest, {
...
var require_StateSafePureComponent = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/VirtualizedList/StateSafePureComponent.js"(exports2, module2) {
    ...
    var _invariant = _interopRequireDefault(require_invariant());
    var React23 = _interopRequireWildcard(require("react"));
    var StateSafePureComponent = class extends React23.PureComponent {
      static {
...
var require_VirtualizedListContext = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/VirtualizedList/VirtualizedListContext.js"(exports2) {
    ...
    var React23 = _react;
    var __DEV__ = process.env.NODE_ENV !== "production";
    var VirtualizedListContext = exports2.VirtualizedListContext = /* @__PURE__ */ React23.createContext(null);
    if (__DEV__) {
      VirtualizedListContext.displayName = "VirtualizedListContext";
    }
    function VirtualizedListContextResetter(_ref) {
      var children = _ref.children;
      return /* @__PURE__ */ React23.createElement(VirtualizedListContext.Provider, {
        value: null
      }, children);
    }
...
var require_VirtualizedListCellRenderer = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/VirtualizedList/VirtualizedListCellRenderer.js"(exports2, module2) {
    ...
    var _invariant = _interopRequireDefault(require_invariant());
    var React23 = _interopRequireWildcard(require("react"));
    var CellRenderer = class extends React23.Component {
      static {
      ...
      _renderElement(renderItem, ListItemComponent, item, index) {
        ...
        if (ListItemComponent) {
          return /* @__PURE__ */ React23.createElement(ListItemComponent, {
            item,
            index,
      ...
      render() {
        ...
        var itemSeparator = /* @__PURE__ */ React23.isValidElement(ItemSeparatorComponent) ? (
          // $FlowFixMe[incompatible-type]
          ItemSeparatorComponent
        ) : (
          // $FlowFixMe[incompatible-type]
          ItemSeparatorComponent && /* @__PURE__ */ React23.createElement(ItemSeparatorComponent, this.state.separatorProps)
        );
        var cellStyle = inversionStyle ? horizontal ? [styles.rowReverse, inversionStyle] : [styles.columnReverse, inversionStyle] : horizontal ? [styles.row, inversionStyle] : inversionStyle;
        var result = !CellRendererComponent ? /* @__PURE__ */ React23.createElement(_View.default, (0, _extends2.default)({
          style: cellStyle,
          onFocusCapture: onCellFocusCapture
        }, onCellLayout && {
          onLayout: this._onLayout
        }), element, itemSeparator) : /* @__PURE__ */ React23.createElement(CellRendererComponent, (0, _extends2.default)({
          cellKey,
          index,
          item,
          style: cellStyle,
        ...
        return /* @__PURE__ */ React23.createElement(_VirtualizedListContext.VirtualizedListCellContextProvider, {
    ...
    var VirtualizedList = class _VirtualizedList extends _StateSafePureComponent.default {
      ...
      constructor(_props) {
        ...
        this._defaultRenderScrollComponent = (props) => {
          ...
          if (this._isNestedWithSameOrientation()) {
            return /* @__PURE__ */ React23.createElement(_View.default, props);
          } else if (onRefresh) {
            ...
            return (
              ...
              /* @__PURE__ */ React23.createElement(_ScrollView.default, (0, _extends2.default)({}, props, {
                refreshControl: props.refreshControl == null ? /* @__PURE__ */ React23.createElement(
            ...
            return /* @__PURE__ */ React23.createElement(_ScrollView.default, props);
          }
        };
      ...
      _pushCells(cells, stickyHeaderIndices, stickyIndicesFromProps, first, last, inversionStyle) {
        ...
        var _loop = /* @__PURE__ */ __name(function _loop2() {
          ...
          cells.push(/* @__PURE__ */ React23.createElement(_VirtualizedListCellRenderer.default, (0, _extends2.default)({
      ...
      render() {
        ...
        if (ListHeaderComponent) {
          ...
          var _element = /* @__PURE__ */ React23.isValidElement(ListHeaderComponent) ? ListHeaderComponent : (
            // $FlowFixMe[not-a-component]
            // $FlowFixMe[incompatible-type-arg]
            /* @__PURE__ */ React23.createElement(ListHeaderComponent, null)
          );
          cells.push(/* @__PURE__ */ React23.createElement(_VirtualizedListContext.VirtualizedListCellContextProvider, {
        ...
        if (itemCount === 0 && ListEmptyComponent) {
          var _element2 = /* @__PURE__ */ React23.isValidElement(ListEmptyComponent) ? ListEmptyComponent : (
            // $FlowFixMe[not-a-component]
            // $FlowFixMe[incompatible-type-arg]
            /* @__PURE__ */ React23.createElement(ListEmptyComponent, null)
          );
          cells.push(/* @__PURE__ */ React23.createElement(_VirtualizedListContext.VirtualizedListCellContextProvider, {
            cellKey: this._getCellKey() + "-empty",
            key: "$empty"
          }, /* @__PURE__ */ React23.cloneElement(_element2, {
        ...
        if (itemCount > 0) {
          ...
          for (var _iterator = (0, _createForOfIteratorHelperLoose2.default)(renderRegions), _step; !(_step = _iterator()).done; ) {
            ...
            if (section.isSpacer) {
              ...
              cells.push(/* @__PURE__ */ React23.createElement(_View.default, {
        ...
        if (ListFooterComponent) {
          var _element3 = /* @__PURE__ */ React23.isValidElement(ListFooterComponent) ? ListFooterComponent : (
            // $FlowFixMe[not-a-component]
            // $FlowFixMe[incompatible-type-arg]
            /* @__PURE__ */ React23.createElement(ListFooterComponent, null)
          );
          cells.push(/* @__PURE__ */ React23.createElement(_VirtualizedListContext.VirtualizedListCellContextProvider, {
        ...
        var innerRet = /* @__PURE__ */ React23.createElement(_VirtualizedListContext.VirtualizedListContextProvider, {
          value: {
            cellKey: null,
        ...
        }, /* @__PURE__ */ React23.cloneElement((this.props.renderScrollComponent || this._defaultRenderScrollComponent)(scrollProps), {
          ref: this._captureScrollRef
        }, cells));
        var ret = innerRet;
        if (this.props.debug) {
          return /* @__PURE__ */ React23.createElement(_View.default, {
            style: styles.debug
      ...
      _renderDebugOverlay() {
        ...
        }, framesInLayout.map((f, ii2) => /* @__PURE__ */ React23.createElement(_View.default, {
          key: "f" + ii2,
          style: [styles.debugOverlayBase, styles.debugOverlayFrame, {
            top: f.offset * normalize,
            height: f.length * normalize
          }]
        })), /* @__PURE__ */ React23.createElement(_View.default, {
...
var require_FlatList = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/FlatList/index.js"(exports2, module2) {
    ...
    var FlatList = class extends React23.PureComponent {
      static {
      ...
      constructor(_props) {
        ...
        this._renderer = (ListItemComponent, renderItem, columnWrapperStyle, numColumns, extraData) => {
          ...
          var render = /* @__PURE__ */ __name((props) => {
            if (ListItemComponent) {
              return /* @__PURE__ */ React23.createElement(ListItemComponent, props);
            } else if (renderItem) {
          ...
          var renderProp = /* @__PURE__ */ __name((info) => {
            if (cols > 1) {
              ...
              return /* @__PURE__ */ React23.createElement(_View.default, {
                ...
                return element != null ? /* @__PURE__ */ React23.createElement(React23.Fragment, {
                  key: kk
                }, element) : null;
              }));
            } else {
      ...
      render() {
        ...
        return (
          ...
          /* @__PURE__ */ React23.createElement(_VirtualizedList.default, (0, _extends2.default)({}, restProps, {
...
var require_createAnimatedComponent = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/Animated/createAnimatedComponent.js"(exports2, module2) {
    ...
    function createAnimatedComponent(Component) {
      return /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
        ...
        return /* @__PURE__ */ React23.createElement(Component, (0, _extends2.default)({}, reducedProps, passthroughProps, {
          style: mergedStyle,
          ref
        }));
      });
...
var require_AnimatedFlatList = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/Animated/components/AnimatedFlatList.js"(exports2, module2) {
    ...
    var FlatListWithEventThrottle = /* @__PURE__ */ React23.forwardRef((props, ref) => /* @__PURE__ */ React23.createElement(_FlatList.default, (0, _extends2.default)({
...
var require_Image = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Image/index.js"(exports2, module2) {
    ...
    function createTintColorSVG(tintColor, id) {
      return tintColor && id != null ? /* @__PURE__ */ React23.createElement("svg", {
        style: {
          position: "absolute",
          height: 0,
          visibility: "hidden",
      ...
      }, /* @__PURE__ */ React23.createElement("defs", null, /* @__PURE__ */ React23.createElement("filter", {
        id: "tint-" + id,
        suppressHydrationWarning: true
      }, /* @__PURE__ */ React23.createElement("feFlood", {
        floodColor: "" + tintColor,
        key: tintColor
      }), /* @__PURE__ */ React23.createElement("feComposite", {
        in2: "SourceAlpha",
        operator: "in"
      })))) : null;
    }
    ...
    var Image = /* @__PURE__ */ React23.forwardRef((props, ref) => {
      ...
      var _React$useState = React23.useState(() => {
      ...
      var _React$useState2 = React23.useState({}), layout = _React$useState2[0], updateLayout = _React$useState2[1];
      var hasTextAncestor = React23.useContext(_TextAncestorContext.default);
      var hiddenImageRef = React23.useRef(null);
      var filterRef = React23.useRef(_filterId++);
      var requestRef = React23.useRef(null);
...
var require_AnimatedScrollView = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/Animated/components/AnimatedScrollView.js"(exports2, module2) {
    ...
    var _ScrollView = _interopRequireDefault(require_ScrollView());
    var _createAnimatedComponent = _interopRequireDefault(require_createAnimatedComponent());
    var ScrollViewWithEventThrottle = /* @__PURE__ */ React23.forwardRef((props, ref) => /* @__PURE__ */ React23.createElement(_ScrollView.default, (0, _extends2.default)({
      scrollEventThrottle: 1e-4
    }, props, {
      ref
    })));
  ...
  "node_modules/react-native-web/dist/cjs/vendor/react-native/VirtualizedSectionList/index.js"(exports2, module2) {
    ...
    var VirtualizedSectionList = class extends React23.PureComponent {
      ...
      render() {
        ...
        return /* @__PURE__ */ React23.createElement(_VirtualizedList.default, (0, _extends2.default)({}, passThroughProps, {
          keyExtractor: this._keyExtractor,
          stickyHeaderIndices,
          renderItem,
    ...
    function ItemWithSeparator(props) {
      ...
      var leadingSeparator = LeadingSeparatorComponent != null && /* @__PURE__ */ React23.createElement(LeadingSeparatorComponent, (0, _extends2.default)({
        highlighted: leadingSeparatorHiglighted
      }, leadingSeparatorProps));
      var separator = SeparatorComponent != null && /* @__PURE__ */ React23.createElement(SeparatorComponent, (0, _extends2.default)({
        highlighted: separatorHighlighted
      }, separatorProps));
      return leadingSeparator || separator ? /* @__PURE__ */ React23.createElement(_View.default, null, inverted === false ? leadingSeparator : separator, element, inverted === false ? separator : leadingSeparator) : element;
    }
...
var require_SectionList = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/SectionList/index.js"(exports2, module2) {
    ...
    var SectionList = class extends React23.PureComponent {
      static {
      ...
      render() {
        ...
        return /* @__PURE__ */ React23.createElement(_VirtualizedSectionList.default, (0, _extends2.default)({}, restProps, {
...
var require_AnimatedSectionList = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/Animated/components/AnimatedSectionList.js"(exports2, module2) {
    ...
    var _createAnimatedComponent = _interopRequireDefault(require_createAnimatedComponent());
    var SectionListWithEventThrottle = /* @__PURE__ */ React23.forwardRef((props, ref) => /* @__PURE__ */ React23.createElement(_SectionList.default, (0, _extends2.default)({
      scrollEventThrottle: 1e-4
    }, props, {
      ref
    })));
...
var require_Text = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Text/index.js"(exports2, module2) {
    ...
    var pickProps = /* @__PURE__ */ __name((props) => (0, _pick.default)(props, forwardPropsList), "pickProps");
    var Text5 = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
      ...
      var handleClick = React23.useCallback((e) => {
        if (onClick != null) {
          onClick(e);
      ...
      return hasTextAncestor ? element : /* @__PURE__ */ React23.createElement(_TextAncestorContext.default.Provider, {
        value: true
      }, element);
    });
...
var require_AppContainer = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/AppRegistry/AppContainer.js"(exports2, module2) {
    ...
    var _StyleSheet = _interopRequireDefault(require_StyleSheet());
    var _View = _interopRequireDefault(require_View());
    var RootTagContext = /* @__PURE__ */ React23.createContext(null);
    var AppContainer = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
      var children = props.children, WrapperComponent = props.WrapperComponent;
      var innerView = /* @__PURE__ */ React23.createElement(_View.default, {
        children,
        key: 1,
        style: styles.appContainer
      });
      if (WrapperComponent) {
        innerView = /* @__PURE__ */ React23.createElement(WrapperComponent, null, innerView);
      }
      return /* @__PURE__ */ React23.createElement(RootTagContext.Provider, {
        value: props.rootTag
      }, /* @__PURE__ */ React23.createElement(_View.default, {
        ref: forwardedRef,
        style: styles.appContainer
...
var require_ActivityIndicator = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/ActivityIndicator/index.js"(exports2, module2) {
    ...
    var createSvgCircle = /* @__PURE__ */ __name((style) => /* @__PURE__ */ React23.createElement("circle", {
      cx: "16",
      cy: "16",
      fill: "none",
      r: "14",
    ...
    var ActivityIndicator = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
      ...
      var svg = /* @__PURE__ */ React23.createElement("svg", {
        height: "100%",
        viewBox: "0 0 32 32",
        width: "100%"
      }, createSvgCircle({
      ...
      return /* @__PURE__ */ React23.createElement(_View.default, (0, _extends2.default)({}, other, {
        "aria-valuemax": 1,
        "aria-valuemin": 0,
        ref: forwardedRef,
        role: "progressbar",
...
var require_TouchableOpacity = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/TouchableOpacity/index.js"(exports2, module2) {
    ...
    function TouchableOpacity(props, forwardedRef) {
      ...
      return /* @__PURE__ */ React23.createElement(_View.default, (0, _extends2.default)({}, rest, pressEventHandlers, {
    ...
    var MemoedTouchableOpacity = /* @__PURE__ */ React23.memo(/* @__PURE__ */ React23.forwardRef(TouchableOpacity));
...
var require_Button = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Button/index.js"(exports2, module2) {
    ...
    var _Text = _interopRequireDefault(require_Text());
    var Button = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
      ...
      return /* @__PURE__ */ React23.createElement(_TouchableOpacity.default, {
        accessibilityLabel,
        ...
        testID
      }, /* @__PURE__ */ React23.createElement(_Text.default, {
...
var require_CheckBox = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/CheckBox/index.js"(exports2, module2) {
    ...
    var CheckBox = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
      ...
      var fakeControl = /* @__PURE__ */ React23.createElement(_View.default, {
        style: [
          styles.fakeControl,
  ...
  "node_modules/react-native-web/dist/cjs/exports/ImageBackground/index.js"(exports2, module2) {
    ...
    var ImageBackground = /* @__PURE__ */ (0, _react.forwardRef)((props, forwardedRef) => {
      ...
      return /* @__PURE__ */ React23.createElement(_View.default, {
        ref: forwardedRef,
        style
      }, /* @__PURE__ */ React23.createElement(_Image.default, (0, _extends2.default)({}, rest, {
        ref: imageRef,
        style: [{
...
var require_KeyboardAvoidingView = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/KeyboardAvoidingView/index.js"(exports2, module2) {
    ...
    var KeyboardAvoidingView = class extends React23.Component {
      static {
      ...
      render() {
        ...
        return /* @__PURE__ */ React23.createElement(_View.default, (0, _extends2.default)({
...
var require_ModalAnimation = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Modal/ModalAnimation.js"(exports2, module2) {
    ...
    function ModalAnimation(props) {
      ...
      var _React$useState = React23.useState(false), isRendering = _React$useState[0], setIsRendering = _React$useState[1];
      var wasVisible = React23.useRef(false);
      var wasRendering = React23.useRef(false);
      var isAnimated = animationType && animationType !== "none";
      var animationEndCallback = React23.useCallback((e) => {
...
var require_ModalContent = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Modal/ModalContent.js"(exports2, module2) {
    ...
    var ModalContent = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
...
var require_ModalFocusTrap = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Modal/ModalFocusTrap.js"(exports2, module2) {
    ...
    var ModalFocusTrap = /* @__PURE__ */ __name((_ref) => {
      ...
      var trapElementRef = React23.useRef();
      var focusRef = React23.useRef({
      ...
      return /* @__PURE__ */ React23.createElement(React23.Fragment, null, /* @__PURE__ */ React23.createElement(FocusBracket, null), /* @__PURE__ */ React23.createElement(_View.default, {
        ref: trapElementRef
      }, children), /* @__PURE__ */ React23.createElement(FocusBracket, null));
    }, "ModalFocusTrap");
...
var require_Modal = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Modal/index.js"(exports2, module2) {
    ...
    var Modal = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
      ...
      return /* @__PURE__ */ React23.createElement(_ModalPortal.default, null, /* @__PURE__ */ React23.createElement(_ModalAnimation.default, {
        animationType,
        onDismiss: onDismissCallback,
        onShow: onShowCallback,
        visible
      }, /* @__PURE__ */ React23.createElement(_ModalFocusTrap.default, {
        active: isActive
      }, /* @__PURE__ */ React23.createElement(_ModalContent.default, (0, _extends2.default)({}, rest, {
        active: isActive,
        onRequestClose,
        ref: forwardedRef,
        transparent
...
var require_Picker = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Picker/index.js"(exports2, module2) {
    ...
    var Picker = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
...
var require_Pressable = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Pressable/index.js"(exports2, module2) {
    ...
    function Pressable(props, forwardedRef) {
      ...
      var blurHandler = React23.useCallback((e) => {
      ...
      var focusHandler = React23.useCallback((e) => {
        if (e.nativeEvent.target === hostRef.current) {
          setFocused(true);
          if (onFocus != null) {
            onFocus(e);
      ...
      var contextMenuHandler = React23.useCallback((e) => {
      ...
      var keyDownHandler = React23.useCallback((e) => {
...
var require_ProgressBar = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/ProgressBar/index.js"(exports2, module2) {
    ...
    var ProgressBar = /* @__PURE__ */ React23.forwardRef((props, ref) => {
...
var require_SafeAreaView = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/SafeAreaView/index.js"(exports2, module2) {
    ...
    var SafeAreaView = /* @__PURE__ */ React23.forwardRef((props, ref) => {
...
var require_Switch = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Switch/index.js"(exports2, module2) {
    ...
    var Switch = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
      ...
      var thumbRef = React23.useRef(null);
      function handleChange(event) {
...
var require_TextInput = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/TextInput/index.js"(exports2, module2) {
    ...
    var TextInput = /* @__PURE__ */ React23.forwardRef((props, forwardedRef) => {
      ...
      var dimensions = React23.useRef({
        height: null,
        width: null
      });
      var hostRef = React23.useRef(null);
      var prevSelection = React23.useRef(null);
      var prevSecureTextEntry = React23.useRef(false);
      React23.useEffect(() => {
      ...
      var handleContentSizeChange = React23.useCallback((hostNode) => {
      ...
      var imperativeRef = React23.useMemo(() => (hostNode) => {
        if (hostNode != null) {
...
var require_TouchableHighlight = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/TouchableHighlight/index.js"(exports2, module2) {
    ...
    function TouchableHighlight(props, forwardedRef) {
      ...
      }), /* @__PURE__ */ React23.cloneElement(child, {
    ...
    var MemoedTouchableHighlight = /* @__PURE__ */ React23.memo(/* @__PURE__ */ React23.forwardRef(TouchableHighlight));
...
var require_TouchableWithoutFeedback = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/TouchableWithoutFeedback/index.js"(exports2, module2) {
    ...
    function TouchableWithoutFeedback(props, forwardedRef) {
      ...
      var pressEventHandlers = (0, _usePressEvents.default)(hostRef, pressConfig);
      var element = React23.Children.only(props.children);
      ...
      return /* @__PURE__ */ React23.cloneElement(element, elementProps, ...children);
    }
    __name(TouchableWithoutFeedback, "TouchableWithoutFeedback");
    var MemoedTouchableWithoutFeedback = /* @__PURE__ */ React23.memo(/* @__PURE__ */ React23.forwardRef(TouchableWithoutFeedback));
...
var require_useColorScheme = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/useColorScheme/index.js"(exports2, module2) {
    ...
    function useColorScheme() {
      var _React$useState = React23.useState(_Appearance.default.getColorScheme()), colorScheme = _React$useState[0], setColorScheme = _React$useState[1];
      React23.useEffect(() => {
...
function useForceUpdate() {
  return isServerSide ? idFn : import_react3.default.useReducer((x) => Math.random(), 0)[1];
}
...
var LayoutGroupContext = import_react4.default.createContext({});
...
function useIsPresent() {
  return isPresent(React5.useContext(PresenceContext));
}
...
var PresenceChild = React6.memo(({
  ...
  const presenceChildren = useConstant(newChildrenMap), id = (0, import_react5.useId)() || "", context = React6.useMemo(
    () => ({
      id,
      initial,
      isPresent: isPresent2,
...
function onlyElements(children) {
  const filtered = [];
  return import_react6.Children.forEach(children, (child) => {
    (0, import_react6.isValidElement)(child) && filtered.push(child);
  }), filtered;
}
...
var AnimatePresence = /* @__PURE__ */ __name(({
  ...
  let forceRender = (0, import_react6.useContext)(LayoutGroupContext).forceRender ?? useForceUpdate();
  const filteredChildren = onlyElements(children), presentChildren = (0, import_react6.useRef)(filteredChildren), allChildren = (0, import_react6.useRef)(/* @__PURE__ */ new Map()).current, exiting = (0, import_react6.useRef)(/* @__PURE__ */ new Set()).current;
  ...
  return exitBeforeEnter && exiting.size && (childrenToRender = []), exiting.forEach((key) => {
    ...
    children: exiting.size ? childrenToRender : (
      ...
      childrenToRender.map((child) => (0, import_react6.cloneElement)(child))
    )
  });
}, "AnimatePresence");
...
var withStaticProperties = /* @__PURE__ */ __name((component, staticProps) => {
  const next = (() => {
    if (component[Decorated]) {
      const _ = import_react7.default.forwardRef((props, ref) => import_react7.default.createElement(component, {
        ...props,
        ref
      }));
...
function useGet(currentValue, initialValue, forwardToFunction) {
  const curRef = React8.useRef(initialValue ?? currentValue);
...
function useControllableState({
  ...
  const [state, setState] = React9.useState(prop ?? defaultProp), previous = React9.useRef(state), propWins = strategy === "prop-wins" && prop !== void 0, value = propWins ? prop : state, onChangeCb = useEvent(onChange || idFn2), transitionFn = transition ? startTransition : emptyCallbackFn;
  React9.useEffect(() => {
...
var Portal = React10.memo((propsIn) => {
  ...
  return passThrough ? children : (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", {
    style: {
      zIndex,
      position: "fixed",
      inset: 0,
...
var PortalProviderComponent = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PortalDispatchContext.Provider, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(PortalStateContext.Provider, {
      value: state,
      children: [children, shouldAddRootHost && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PortalHost, {
        name: rootHostName
      })]
    })
  });
...
var defaultRenderer = /* @__PURE__ */ __name((children) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, {
  children
}), "defaultRenderer");
var PortalHost = (0, import_react12.memo)(function(props) {
  return isWeb ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PortalHostWeb, {
    ...props
...
function PortalHostWeb(props) {
  ...
  }, [props.name]), /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", {
    style: {
      display: "contents"
    },
...
function createCollection(name) {
  const {
    ...
    const {
      scope,
      children
    } = props, ref = import_react14.default.useRef(void 0), itemMap = import_react14.default.useRef(/* @__PURE__ */ new Map()).current;
  ...
  const COLLECTION_SLOT_NAME = name + "CollectionSlot", CollectionSlot = import_react14.default.forwardRef((props, forwardedRef) => {
    const {
      scope,
      children
    } = props, context = useCollectionContext(scope), composedRefs = useComposedRefs(forwardedRef, context.collectionRef);
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_core4.Slot, {
      ref: composedRefs,
      children
    });
  });
  CollectionSlot.displayName = COLLECTION_SLOT_NAME;
  const ITEM_SLOT_NAME = name + "CollectionItemSlot", ITEM_DATA_ATTR = "data-collection-item", CollectionItemSlot = import_react14.default.forwardRef((props, forwardedRef) => {
    const {
      scope,
      children,
      ...itemData
    } = props, ref = import_react14.default.useRef(void 0), composedRefs = useComposedRefs(forwardedRef, ref), context = useCollectionContext(scope);
    return import_react14.default.useEffect(() => (context.itemMap.set(ref, {
      ref,
      ...itemData
    }), () => void context.itemMap.delete(ref))), /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_core4.Slot, {
      [ITEM_DATA_ATTR]: "",
      ref: composedRefs,
      children
    });
...
var ToastContext = import_react15.default.createContext({});
var ToastCurrentContext = import_react15.default.createContext(null);
var useToastController = /* @__PURE__ */ __name(() => import_react15.default.useContext(ToastContext), "useToastController");
var useToastState = /* @__PURE__ */ __name(() => import_react15.default.useContext(ToastCurrentContext), "useToastState");
...
var ToastImperativeProvider = /* @__PURE__ */ __name(({
  ...
  const counterRef = import_react15.default.useRef(0), [toast, setToast] = import_react15.default.useState(null), [lastNativeToastRef, setLastNativeToastRef] = import_react15.default.useState(null), show = import_react15.default.useCallback((title, showOptions) => {
  ...
  }, [setToast, JSON.stringify(options.native || null)]), hide = import_react15.default.useCallback(() => {
  ...
  }, [setToast, lastNativeToastRef]), contextValue = import_react15.default.useMemo(() => ({
    show,
    hide,
    nativeToast: lastNativeToastRef,
    options
  }), [show, hide, lastNativeToastRef, JSON.stringify(options || null)]);
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ToastContext.Provider, {
    value: contextValue,
    children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ToastCurrentContext.Provider, {
      value: toast,
      children
    })
  });
...
var ToastProvider = /* @__PURE__ */ __name((props) => {
  const {
    ...
    swipeThreshold = 50,
    children
  } = props, backupId = React15.useId(), id = providedId ?? backupId, [viewports, setViewports] = React15.useState({}), [toastCount, setToastCount] = React15.useState(0), isFocusedToastEscapeKeyDownRef = React15.useRef(false), isClosePausedRef = React15.useRef(false), handleViewportChange = React15.useCallback((name, viewport) => {
    startTransition(() => {
      setViewports((prev) => ({
        ...prev,
        [name]: viewport
  ...
  }, []), options = React15.useMemo(() => ({
    duration,
    burntOptions,
    native,
    notificationOptions
  }), [JSON.stringify([duration, burntOptions, native, notificationOptions])]);
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Collection.Provider, {
    scope,
    children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ToastProviderProvider, {
      scope,
      id,
      label,
      duration,
      ...
      onToastAdd: React15.useCallback(() => {
        startTransition(() => {
          setToastCount((prevCount) => prevCount + 1);
        });
      }, []),
      onToastRemove: React15.useCallback(() => {
        startTransition(() => {
          setToastCount((prevCount) => prevCount - 1);
        });
      }, []),
      ...
      isClosePausedRef,
      options,
      children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ToastImperativeProvider, {
        options,
        children
      })
    })
...
var ToastAnnounceExclude = React16.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(ToastAnnounceExcludeFrame, {
...
var ToastAnnounce = /* @__PURE__ */ __name((props) => {
  const {
    ...
    children,
    ...announceProps
  } = props, context = useToastProviderContext(scope), [renderAnnounceText, setRenderAnnounceText] = React16.useState(false), [isAnnounced, setIsAnnounced] = React16.useState(false);
  return useNextFrame(() => {
    startTransition(() => {
  ...
  }, []), isAnnounced ? null : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Portal, {
    children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(VisuallyHidden, {
      ...announceProps,
      children: renderAnnounceText && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_core7.Text, {
...
function useCallbackRef(callback) {
  ...
  }), React17.useMemo(() => (...args) => callbackRef.current?.(...args), []);
}
...
var DismissableContext = React19.createContext({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set()
});
var Dismissable = React19.forwardRef((props, forwardedRef) => {
  const {
...
var DismissableBranch = React19.forwardRef((props, forwardedRef) => {
  const context = React19.useContext(DismissableContext), ref = React19.useRef(null), composedRefs = useComposedRefs(forwardedRef, ref);
  return React19.useEffect(() => {
    const node = ref.current;
    if (node) return context.branches.add(node), () => {
      context.branches.delete(node);
    };
  }, [context.branches]), /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", {
    style: {
      display: "contents"
    },
    ...props,
...
function usePointerDownOutside(onPointerDownOutside) {
  const handlePointerDownOutside = useEvent(onPointerDownOutside), isPointerInsideReactTreeRef = React19.useRef(false), handleClickRef = React19.useRef(() => {
  });
  return React19.useEffect(() => {
...
function useFocusOutside(onFocusOutside) {
  const handleFocusOutside = useEvent(onFocusOutside), isFocusInsideReactTreeRef = React19.useRef(false);
  return React19.useEffect(() => {
...
function ToastPortal(props) {
  ...
  return (import_react_native_web.Platform.OS === "android" || import_react_native_web.Platform.OS === "ios") && (content = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ReprogapateToastProvider, {
    context,
    children
  })), /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Portal, {
...
var ToastViewport = React20.memo(React20.forwardRef((props, forwardedRef) => {
  const {
    scope,
    ...
    portalToRoot,
    ...viewportProps
  } = props, context = useToastProviderContext(scope), getItems = useCollection(scope || TOAST_CONTEXT), headFocusProxyRef = React20.useRef(null), tailFocusProxyRef = React20.useRef(null), wrapperRef = React20.useRef(null), ref = React20.useRef(null), onViewportChange = React20.useCallback((el) => {
  ...
  }, [hotkey, context.toastCount]), React20.useEffect(() => {
    if (!isWeb || context.toastCount === 0) return;
  ...
  const contents = /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(ToastViewportWrapperFrame, {
    ref: wrapperRef,
    role: "region",
    "aria-label": label.replace("{hotkey}", hotkeyLabel),
    tabIndex: -1,
    children: [hasToasts && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FocusProxy, {
      context,
      viewportName: name,
    ...
    }), /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Collection.Slot, {
      scope: context.toastScope,
      children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ToastViewportFrame, {
        focusable: context.toastCount > 0,
        ref: composedRefs,
        ...viewportProps,
        children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(PortalHost, {
          render: /* @__PURE__ */ __name((children) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(AnimatePresence, {
    ...
    }), hasToasts && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FocusProxy, {
      context,
      viewportName: name,
  ...
  return portalToRoot ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ToastPortal, {
    context,
...
var FocusProxy = React20.forwardRef((props, forwardedRef) => {
  const {
    onFocusFromOutsideViewport,
    viewportName,
    context,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(VisuallyHidden, {
    "aria-hidden": true,
    tabIndex: 0,
    ...proxyProps,
    ref: forwardedRef,
...
var ToastImpl = React21.forwardRef((props, forwardedRef) => {
  const {
    scope,
    type = "foreground",
    ...
    ...toastProps
  } = props, isPresent2 = useIsPresent(), context = useToastProviderContext(scope), [node, setNode] = React21.useState(null), composedRefs = useComposedRefs(forwardedRef, setNode), duration = durationProp || context.duration, closeTimerStartTimeRef = React21.useRef(0), closeTimerRemainingTimeRef = React21.useRef(duration), closeTimerRef = React21.useRef(0), {
    onToastAdd,
    onToastRemove
  } = context, viewport = React21.useMemo(() => context.viewports[viewportName], [context.viewports, viewportName]), handleClose = (0, import_core9.useEvent)(() => {
    isPresent2 && (isWeb && node?.contains(document.activeElement) && viewport?.focus(), onClose());
  }), startTimer = React21.useCallback((duration2) => {
  ...
  }, [handleClose]), handleResume = React21.useCallback(() => {
    startTimer(closeTimerRemainingTimeRef.current), onResume?.();
  }, [onResume, startTimer]), handlePause = React21.useCallback(() => {
  ...
  }, [viewport, duration, onPause, onResume, startTimer]), React21.useEffect(() => {
    open && !context.isClosePausedRef.current && startTimer(duration);
  }, [open, duration, context.isClosePausedRef, startTimer]), React21.useEffect(() => (onToastAdd(), () => onToastRemove()), [onToastAdd, onToastRemove]);
  const announceTextContent = React21.useMemo(() => isWeb && node ? getAnnounceTextContent(node) : null, [node]), isHorizontalSwipe = ["left", "right", "horizontal"].includes(context.swipeDirection), {
    animationDriver
  ...
  }), panResponder = React21.useMemo(() => import_react_native_web2.PanResponder.create({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, {
    children: [announceTextContent && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(ToastAnnounce, {
      scope,
      role: "status",
      "aria-live": type === "foreground" ? "assertive" : "polite",
      "aria-atomic": true,
      children: announceTextContent
    }), /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(GorhomPortalItem, {
      hostName: viewportName ?? "default",
      children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(ToastInteractiveProvider, {
        scope,
        onClose: /* @__PURE__ */ __name(() => {
          handleClose();
        }, "onClose"),
        children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Dismissable, {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_core9.Theme, {
            contain: true,
            forceClassName: true,
            name: themeName,
            children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(AnimatedView, {
              ...panResponder?.panHandlers,
              style: [{
                margin: "auto"
              }, animatedStyles],
              children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Collection.ItemSlot, {
                scope: context.toastScope,
                children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(ToastImplFrame, {
                  role: "status",
                  "aria-live": "off",
                  "aria-atomic": true,
...
var ToastAction = React22.forwardRef(function(props, forwardedRef) {
  const {
    altText,
    ...actionProps
  } = props;
  return altText ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(ToastAnnounceExclude, {
    altText,
    asChild: true,
    children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(ToastClose, {
      ...actionProps,
      ref: forwardedRef
    })
  }) : null;
...
var ToastClose = React22.forwardRef(function(props, forwardedRef) {
  const {
    scope,
    ...closeProps
  } = props, interactiveContext = useToastInteractiveContext(scope);
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(ToastAnnounceExclude, {
    asChild: true,
    children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(ToastCloseFrame, {
...
var ToastComponent = ToastImplFrame.styleable(function(props, forwardedRef) {
  const {
    ...
    hide
  } = useToastController(), id = React22.useId(), onPause = (0, import_core10.useEvent)(props.onPause), onResume = (0, import_core10.useEvent)(props.onResume), isHide = currentToast?.hide === true;
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(AnimatePresence, {
    children: (forceMount || open) && !isHide ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(ToastImpl, {
      id,
      open,
      ...toastProps,
      ref: forwardedRef,
