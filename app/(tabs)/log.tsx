        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>
              Choisis ton emoji, explique le contexte et partage avec qui tu veux.
            </Text>
          </View>
          ...
          <View style={styles.card}>
            <View style={styles.row}>
              <Text style={styles.sectionTitle}>Souhaites-tu rester anonyme ?</Text>
          ...
          <View style={styles.card}>
            ...
            />
            {isLoadingCategories ? <Text style={styles.loading}>Chargement des catégories...</Text> : null}
          </View>
          ...
          <View style={styles.card}>
            ...
            />
            <Text style={styles.muted}>
              Plus tu es précis, plus on pourra t’accompagner avec les bons leviers.
            </Text>
            <Text style={[styles.sectionTitle, styles.noteTitle]}>Tu veux détailler ?</Text>
            <TextInput
